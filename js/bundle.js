...
function calc() {
    ...
    function initLocalSattings (selector, activeClass) {
    ...
    initLocalSattings('#gender div', 'calculating__choose-item_active');
    initLocalSattings('.calculating__choose_big div', 'calculating__choose-item_active');
